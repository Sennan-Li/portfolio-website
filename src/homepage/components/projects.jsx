...
export default function Projects() {
  ...
  return (
    <section id='project'>
      ...
      <div className='intro'>
       <p >Hi, I am Sennan Li, graduated from University of York (MSc Computer Science) Plain and Simple, I love Web Development, I am passionate about building clean and useful websites.</p>
      </div>
