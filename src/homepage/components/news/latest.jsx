...
export default function Latest() {
  return (
    <div className='article'>
      <Heading articleTitle={articleConstants.articleTitleLatest} articleDate={articleConstants.articleDateLatest} articleLink="exp://exp.host/@sennan/home-care-app?release-channel=default"/>
